...
public class WailaPlugin implements IIntegrationPlugin {
    ...
    @Override
    public void init() {
        FMLInterModComms.sendMessage("waila", "register", "eutros.fcd.integration.waila.WailaPlugin.register");
    }
